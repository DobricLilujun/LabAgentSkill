...
class SkillProperties:
    ...
    body: Optional[str] = None  # Optional field to hold the body content of SKILL.md
    path: Optional[str] = None  # Optional field to hold the path to the skill directory
